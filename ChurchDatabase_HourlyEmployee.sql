...
CREATE TABLE `HourlyEmployee` (
  ...
  `Hourly_Pay` double DEFAULT NULL,
  PRIMARY KEY (`HE_ID`),
  KEY `EmployeeID_idx` (`EmployeeID`),
  CONSTRAINT `Reference` FOREIGN KEY (`EmployeeID`) REFERENCES `Employee` (`EmployeeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `HourlyEmployee` VALUES (1239,1,12),(1240,2,10),(1241,3,12),(1242,4,10),(1243,5,11),(1244,6,10),(1245,7,11);
