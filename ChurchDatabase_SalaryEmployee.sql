...
CREATE TABLE `SalaryEmployee` (
  ...
  CONSTRAINT `Employee` FOREIGN KEY (`EmployeeID`) REFERENCES `Employee` (`EmployeeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `SalaryEmployee` WRITE;
/*!40000 ALTER TABLE `SalaryEmployee` DISABLE KEYS */;
/*!40000 ALTER TABLE `SalaryEmployee` ENABLE KEYS */;
UNLOCK TABLES;
